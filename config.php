...
define('HTTP_SERVER', 'http://tinanailsupply.com/changestyle/');
define('HTTPS_SERVER', 'http://tinanailsupply.com/changestyle/');
...
define('DB_DRIVER', 		'mysqli');
// define('DB_HOSTNAME', 	'107.180.27.158'); 
define('DB_HOSTNAME', 		'localhost'); 
define('DB_USERNAME', 		'thepronails');
define('DB_PASSWORD', 		'thepronails@123');
define('DB_DATABASE', 		'thepronails');
define('DB_PORT', 			'3306');
define('DB_PREFIX', 		'oc_');
