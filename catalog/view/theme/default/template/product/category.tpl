          ...
          <div class="product-thumb">
            ...
            <div>
              ...
              <div class="button-group">
                <button class='add-cart' type="button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"></span></button>
