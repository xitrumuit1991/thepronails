...
$_['text_month']			= 'Tháng';
$_['text_year']				= 'Năm';
$_['text_recurring']	    = '<p><i class="fa fa-info-circle"></i> số tiền định kỳ được tính theo tần số và chu kỳ.</p><p>Ví dụ, nếu bạn sử dụng một tần số " tuần " và một chu kỳ " 2 " , sau đó người dùng sẽ được lập hoá đơn 2 tuần một lần.</p><p>thời gian là số lần người dùng sẽ thực hiện thanh toán , thiết lập là 0 nếu bạn muốn thanh toán cho đến khi họ được hủy bỏ.</p>';
